...
// Insert your own databse address and mysql root password
    Conn con=new Conn();
    
    String query = "Select * from customer WHERE username="+"\'"+c1.getSelectedItem()+"\'"+";";
    ...
    while(rs.next())
    {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            String queryDelete = "Delete from customer where username = "+"\'"+c1.getSelectedItem()+"\'"+";";
                            PreparedStatement preparedStmt = c.c.prepareStatement(queryDelete);
